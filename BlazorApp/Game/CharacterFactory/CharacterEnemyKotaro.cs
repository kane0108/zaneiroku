...
{
    public class CharacterEnemyKotaro : BaseCharacterFactory
    {
        public override Character Create()
        {
            var character = CreateCharacterBase(1, "風魔小太郎", 100, 100);

            // 立ち絵と立ち絵番号
            character.PortraitImagePath = "images/ch00-01.png";
            character.PortraitId = 4;

            // 戦闘アニメーション画像
            var sheetPath = "images/ch06-00.png";
